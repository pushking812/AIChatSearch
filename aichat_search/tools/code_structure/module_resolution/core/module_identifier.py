...
from aichat_search.tools.code_structure.module_resolution.models.identifier_models import (
...
from aichat_search.tools.code_structure.module_resolution.models.containers import Version
